 ...
 * 
 * Shamelessly stolen and mutilated by Jesse the Game.
 */
...
(function($){
  ...
  $.fn.replaceText = function( search, replace, text_only, return_count ) {
    // Number of replacements resolved
    var count = 0; 
    ...
    return return_count ? count : this;
  };  
